<?php
/* Smarty version 3.1.30, created on 2018-03-14 23:18:26
  from "/Applications/XAMPP/xamppfiles/htdocs/application/views/admin/ads_index.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5aa93d4223a985_77132294',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1da7069d382c5367b6bce4d6243f830eaeccdc6e' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/application/views/admin/ads_index.html',
      1 => 1519874488,
      2 => 'file',
    ),
  ),
...
function content_5aa93d4223a985_77132294 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
<body>
    ...
    <table class="layui-hide" id="table_type" lay-filter="ads"></table>
    <?php echo '<script'; ?>
...
Ads/getInfo',
        ...
        //监听表格复选框选择
		table.on('checkbox(ads)', function(obj){
			console.log(obj);
		});

        //监听工具条
        table.on('tool(ads)', function(obj) {
            var data = obj.data;
            if (obj.event === 'del') {
